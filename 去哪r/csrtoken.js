...
ooo=function(e) {
    var t = {
        id: "db768f3cf58efc2e686cfae418d3eb3c",
...
console.log('csrtoken=',n)
            ...
            n["run"] = t._run;
 n["run"] ({ 'u' : '__loginInfo_u__', 't' : '__loginInfo_t__', 'l' : '__loginInfo_l__', 'r' : '__loginInfo_r__' });
return;
    ...
    e.____MODULES["db768f3cf58efc2e686cfae418d3eb3c"] = t.exports
}
(this);
return;
(function(e) {
...
(function(e) {
    var t = {
        id: "781509c6b1437a7e4a09427544a6162e",
    ...
    var n = function(e, t, n) {
        (function() {
            ...
            var p = n("li", "last wx_phone_icon");
            var d = n("i", "phone_icon");
            var v = n("i", "wx_icon");
            d.innerHTML = "";
            v.innerHTML = "";
            p.appendChild(d);
            p.appendChild(v);
            h.appendChild(p);
            var m = n("div", "picture phone_picture");
            var g = n("div", "picture wx_picture");
            p.appendChild(m);
            p.appendChild(g);
            var y = n("div", "content_div");
            m.appendChild(y);
            var b = n("img");
            b.setAttribute("src", "https://picbed.qunarzz.com/130abe0fc455a1a829e34d55af2c41fc.jpg");
            y.appendChild(b);
            var w = n("div", "words_grey");
            w.innerHTML = "扫码下载去哪儿App";
            y.appendChild(w);
            var E = n("div", "get_gift");
            E.innerHTML = "领500元新人大礼包";
            y.appendChild(E);
            var S = n("div", "content_div");
            g.appendChild(S);
            var x = n("img");
            x.setAttribute("src", "https://picbed.qunarzz.com/3b532222b23f8bc29be8e3b06bb2edc6.jpg");
            S.appendChild(x);
            var T = n("div", "words_grey");
            T.innerHTML = "关注去哪儿公众号";
            S.appendChild(T);
            var N = n("div", "words_grey");
            N.innerHTML = "优惠信息即刻知晓";
            S.appendChild(N);
            var C = n("div", "search_input_div");
            C.setAttribute("id", "search_input_div");
            s.appendChild(C);
            var k = n("div", "left_input_div");
            C.appendChild(k);
            var L = n("i", "icon-search");
            L.innerHTML = "?";
            C.appendChild(L);
            var A = n("input", "left_input");
            A.setAttribute("placeholder", "搜索目的地");
            A.setAttribute("id", "header_search_input");
            k.appendChild(A);
            var O = n("ul", "search_results");
            O.setAttribute("id", "search_results_list");
            C.appendChild(O);
            var M = window.__QC_SEARCH_DATA.navList;
            var _ = window.__QC_SEARCH_DATA.initSubList;
            f.innerHTML = "";
            var D = n("ul");
            f.appendChild(D);
            var P = n("div", "q_header_tags");
            P.setAttribute("id", "__header_nav_tags__");
            f.appendChild(P);
            ...
            var F = n("li", "qhf_navmore");
            F.setAttribute("id", "__header_navmore__");
            var I = n("a", "q_header_navlink q_header_navlink_more");
            var q = n("span");
            var R = n("i");
            var U = n("b");
            U.innerHTML = "更多";
            ...
            I.appendChild(R);
            F.appendChild(I);
            var z = n("div", "q_header_navmore-con");
            z.setAttribute("id", "__header_navmore_con__");
            F.appendChild(z);
            D.appendChild(F);
            D.children[0].className += " qhf_cur";
            ...
            ;
            var W = n("div", "custom_div");
            s.appendChild(W);
            var X = n("div", "left_custom");
            W.appendChild(X);
            var V = n("ul", "right_custom");
            W.appendChild(V);
            var $ = n("i", "icon-custom");
            X.appendChild($);
            var J = n("span", "custom_24");
            X.appendChild(J);
            J.innerHTML = "24小时";
            $.innerHTML = "";
            var K = [{
            ...
            for (var j = 0; j < K.length; j++) {
                var Q = n("li", "item_custom");
                V.appendChild(Q);
                var G = n("span", "item_custom_words");
                var Y = n("span", "item_custom_num");
                G.innerHTML = K[j].title;
                Y.innerHTML = K[j].num;
                Q.appendChild(G);
                Q.appendChild(Y)
            }
    ...
    e.____MODULES["781509c6b1437a7e4a09427544a6162e"] = t.exports
}
)(this);
(function(e) {
    var t = {
...
(function(e) {
    var t = {
        id: "df17d985ed6c90bfd042992a2c0334be",
        filename: "nav.js",
        exports: {}
    };
    if (!e.____MODULES) {
    ...
    var n = function(t, n, r) {
        (function() {
            ...
            var n = window["QNR"]["hfUtils"]
              , r = ["package", "travel", "piao", "tuan", "ddr", "car"]
    ...
    e.____MODULES["df17d985ed6c90bfd042992a2c0334be"] = t.exports
}
)(this);
(function(e) {
    var t = {
        id: "96181be344c4f33b65f852b2be595014",
    ...
    e.____MODULES["96181be344c4f33b65f852b2be595014"] = t.exports
}
)(this);
(function(e) {
    var t = {
...
(function(e) {
    var t = {
        id: "881f8ecbd64a2fb15f0e3cddf69d9b45",
    ...
    e.____MODULES["881f8ecbd64a2fb15f0e3cddf69d9b45"] = t.exports
}
)(this);
(function(e) {
    var t = {
...
(function(e) {
    ...
    var n = function(t, n, r) {
        ...
        e.____MODULES["db768f3cf58efc2e686cfae418d3eb3c"];
        e.____MODULES["e5921b50a3d3d91e99b0b2807c5fc360"];
        e.____MODULES["781509c6b1437a7e4a09427544a6162e"];
        e.____MODULES["df17d985ed6c90bfd042992a2c0334be"];
        e.____MODULES["96181be344c4f33b65f852b2be595014"];
        e.____MODULES["450b2c6e3157a0b22648d48fbb5d5a66"];
        e.____MODULES["881f8ecbd64a2fb15f0e3cddf69d9b45"];
